#pragma once
// Equity Research Screen — Fincept-style multi-tab research terminal
...
private:
    ...
    // Section renderers
    void render_header(float h = 32);
    void render_ticker_bar(float h = 44);
    void render_sub_tabs(float h = 28);
    void render_content(float h = 0);
    void render_footer();

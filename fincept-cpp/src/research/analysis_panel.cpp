...
void AnalysisPanel::render(ResearchData& data) {
    ...
    float half_w = (avail.x - 8) * 0.5f;
    float half_h = (avail.y - 8) * 0.5f;

    // ── Top Left: Financial Health ──
    ImGui::BeginChild("##fh", ImVec2(half_w, half_h), true);
    ...
    ImGui::BeginChild("##ev", ImVec2(half_w, half_h), true);
    ...
    ImGui::BeginChild("##rp", ImVec2(half_w, 0), true);
    ...
    ImGui::BeginChild("##kr", ImVec2(half_w, 0), true);

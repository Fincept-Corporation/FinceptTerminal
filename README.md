...
**Version:** `v3.1.6` | **Released:** 2026-01-11

| Platform | Architecture | Download |
|----------|-------------|----------|
| **macOS** | Apple Silicon | [Download](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-arm64.dmg) |
| **macOS** | Intel | [Download](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-x64.dmg) |
| **Linux** | x64 (AppImage) | [Download](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.AppImage) |
| **Linux** | x64 (Debian) | [Download](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.deb) |
| **Windows** | x64 | [Download](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Windows-x64.msi) |

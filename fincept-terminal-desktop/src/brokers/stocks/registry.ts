...
// In-memory adapter registry for dynamically registered broker adapters
const adapterRegistry: Record<string, any> = {};

export function registerBrokerAdapter(brokerId: string, adapterClass: any): void {
  adapterRegistry[brokerId] = adapterClass;
}

export function getRegisteredAdapter(brokerId: string): any | undefined {
  return adapterRegistry[brokerId];
}

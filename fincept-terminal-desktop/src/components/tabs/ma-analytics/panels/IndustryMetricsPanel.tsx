...
export const IndustryMetricsPanel: React.FC<{ selectedDeal?: any }> = () => (
  <div style={COMMON_STYLES.emptyState}>
    <Activity size={48} style={{ opacity: 0.3, marginBottom: SPACING.DEFAULT }} />
    <div style={{ fontSize: TYPOGRAPHY.BODY, color: FINCEPT.GRAY }}>IndustryMetricsPanel - Under Construction</div>
  </div>
);

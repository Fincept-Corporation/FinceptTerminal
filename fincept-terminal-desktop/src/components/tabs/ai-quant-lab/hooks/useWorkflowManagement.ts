...
export interface UseWorkflowManagementReturn {
  ...
  handleViewResults: (workflow: WorkflowType) => { showModal: boolean; data: any; name: string } | { navigate: boolean };
...
export function useWorkflowManagement(): UseWorkflowManagementReturn {
  ...
  const handleViewResults = useCallback(
    (workflow: WorkflowType): { showModal: boolean; data: any; name: string } | { navigate: boolean } => {

/**
 * Backtesting Panel - Bloomberg Professional Design
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="pb-3 border-b" style={{ borderColor: BLOOMBERG.BORDER }}>
            <div className="flex items-center gap-2 mb-1">
              <BarChart3 size={18} color={BLOOMBERG.ORANGE} />
        ...
        {error ? (
          <div className="flex items-center justify-center h-full">
            <div
              ...
              style={{ backgroundColor: BLOOMBERG.PANEL_BG, borderColor: BLOOMBERG.RED }}
            >
              <div className="flex items-center gap-3 mb-3">
                <AlertCircle size={24} color={BLOOMBERG.RED} />
                <h3 className="text-sm font-bold uppercase tracking-wide" style={{ color: BLOOMBERG.WHITE }}>
                  BACKTEST ERROR
                </h3>
              </div>
              <p className="text-xs font-mono" style={{ color: BLOOMBERG.GRAY }}>
          ...
          <div className="space-y-6 max-w-5xl">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold uppercase tracking-wide mb-1" style={{ color: BLOOMBERG.WHITE }}>
                  BACKTEST RESULTS
                </h2>
                <p className="text-xs font-mono" style={{ color: BLOOMBERG.GRAY }}>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <MetricCard
                  ...
                  color={backtestResults.annual_return && backtestResults.annual_return > 0 ? BLOOMBERG.GREEN : BLOOMBERG.RED}
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center max-w-md">
              <BarChart3 size={64} color={BLOOMBERG.GRAY} className="mx-auto mb-4" />
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-bold font-mono flex items-center gap-2" style={{ color }}>
        {value}
        {positive !== undefined && (
          positive ? <TrendingUp size={16} color={BLOOMBERG.GREEN} /> : <TrendingDown size={16} color={BLOOMBERG.RED} />
        )}
      </div>
    </div>
  );

...
import {
  ...
  RefreshCw, Circle, History, Trash2, PlayCircle,
  StopCircle, XCircle, Check, BarChart3, Brain,
} from 'lucide-react';
import { withErrorBoundary } from '@/components/common/ErrorBoundary';
import { APP_VERSION } from '@/constants/version';
import { useAlphaArena } from './useAlphaArena';
...
import { FINCEPT, TERMINAL_FONT, TERMINAL_STYLES, TRADING_SYMBOLS, COMPETITION_MODES } from './constants';

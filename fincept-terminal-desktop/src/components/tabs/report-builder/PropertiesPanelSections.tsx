// PropertiesPanel - per-component-type property editor sections

import React from 'react';
import { X, Plus, FileX } from 'lucide-react';
import { FONT_SIZES, CHART_TYPES } from './constants';

// Shared props passed to all section components
...
// ── Text / Heading / Code ──────────────────────────────────────────────────
export function ContentSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
...
// ── Quote ──────────────────────────────────────────────────────────────────
export function QuoteSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Disclaimer ────────────────────────────────────────────────────────────
export function DisclaimerSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Alignment ─────────────────────────────────────────────────────────────
export function AlignmentSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Alignment
...
// ── Font Size ─────────────────────────────────────────────────────────────
export function FontSizeSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Font Size
...
// ── Image Upload ──────────────────────────────────────────────────────────
export function ImageSection({ selectedComponent, onUpdateComponent, colors, onImageUpload }: SectionProps) {
  return (
    <div>
...
// ── Table Columns ─────────────────────────────────────────────────────────
export function TableSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
      ...
      <input
        ...
        onChange={(e) => onUpdateComponent(selectedComponent.id, {
          config: { ...selectedComponent.config, columns: e.target.value.split(',').map((s: string) => s.trim()) }
        })}
        className="w-full px-3 py-2 text-xs rounded bg-[#0a0a0a] border border-[#333333] focus:border-[#FFA500] outline-none"
        style={{ color: colors.text }}
...
// ── Chart Type ────────────────────────────────────────────────────────────
export function ChartSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Chart Type
...
// ── Section Settings ──────────────────────────────────────────────────────
export function SectionSettingsSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Columns Count ─────────────────────────────────────────────────────────
export function ColumnsSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Number of Columns
...
// ── KPI Settings ──────────────────────────────────────────────────────────
export function KpiSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-2 block" style={{ color: colors.textMuted }}>
        KPI Cards
...
// ── Sparkline ─────────────────────────────────────────────────────────────
export function SparklineSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
      ...
      <input
        ...
        onChange={(e) => {
          const data = e.target.value.split(',').map((v: string) => parseFloat(v.trim())).filter((v: number) => !isNaN(v));
          onUpdateComponent(selectedComponent.id, {
...
// ── Live Table ────────────────────────────────────────────────────────────
export function LiveTableSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Dynamic Chart ─────────────────────────────────────────────────────────
export function DynamicChartSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── List ──────────────────────────────────────────────────────────────────
export function ListSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Table of Contents ─────────────────────────────────────────────────────
export function TocSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Show Page Numbers
...
// ── Divider ───────────────────────────────────────────────────────────────
export function DividerSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <div>
      <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
        Color
...
// ── Page Break ────────────────────────────────────────────────────────────
export function PageBreakSection({ colors }: { colors: any }) {
  return (
...
// ── Cover Page ────────────────────────────────────────────────────────────
export function CoverPageSection({ selectedComponent, onUpdateComponent, colors, onImageUpload }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Subheading ────────────────────────────────────────────────────────────
export function SubheadingSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Signature ─────────────────────────────────────────────────────────────
export function SignatureSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── QR Code ───────────────────────────────────────────────────────────────
export function QrCodeSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>
...
// ── Watermark ─────────────────────────────────────────────────────────────
export function WatermarkSection({ selectedComponent, onUpdateComponent, colors }: SectionProps) {
  return (
    <>
      <div>
        <label className="text-xs font-semibold mb-1 block" style={{ color: colors.textMuted }}>

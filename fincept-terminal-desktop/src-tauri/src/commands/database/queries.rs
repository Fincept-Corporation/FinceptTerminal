// commands/database/queries.rs - Database delegation commands (health, settings, credentials, LLM, chat, data sources, MCP, backtesting, context, watchlist, notes, excel, agents)

...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skfolio::skfolio_risk_metrics,
            commands::skfolio::skfolio_measures,
            commands::skfolio::skfolio_validate_model,
            ...
            commands::pyportfolioopt::pyportfolioopt_sensitivity_analysis,
            commands::pyportfolioopt::pyportfolioopt_risk_parity,
            commands::pyportfolioopt::pyportfolioopt_equal_weight,
            commands::pyportfolioopt::pyportfolioopt_inverse_volatility,
            commands::pyportfolioopt::pyportfolioopt_market_neutral,
            commands::pyportfolioopt::pyportfolioopt_min_tracking_error,
            commands::pyportfolioopt::pyportfolioopt_max_diversification,
            commands::pyportfolioopt::pyportfolioopt_custom_constraints,
            commands::pyportfolioopt::pyportfolioopt_views_optimization,
            ...
            // py_vollib - Options Pricing (Black, BS, BSM)
            commands::vollib::vollib_black_price,
            commands::vollib::vollib_black_greeks,
            commands::vollib::vollib_black_iv,
            commands::vollib::vollib_bs_price,
            commands::vollib::vollib_bs_greeks,
            commands::vollib::vollib_bs_iv,
            commands::vollib::vollib_bsm_price,
            ...
            commands::gluonts::gluonts_forecast_feedforward,
            commands::gluonts::gluonts_forecast_deepar,
            commands::gluonts::gluonts_forecast_tft,
            commands::gluonts::gluonts_forecast_wavenet,
            commands::gluonts::gluonts_forecast_dlinear,
            commands::gluonts::gluonts_forecast_patchtst,
            commands::gluonts::gluonts_forecast_tide,
            commands::gluonts::gluonts_forecast_lagtst,
            commands::gluonts::gluonts_forecast_deepnpts,
            commands::gluonts::gluonts_predict_seasonal_naive,
            commands::gluonts::gluonts_predict_mean,
            commands::gluonts::gluonts_predict_constant,
            commands::gluonts::gluonts_evaluate,
            // TALIpp - Incremental Technical Analysis Indicators
            commands::talipp::talipp_trend,
            commands::talipp::talipp_trend_advanced,
            commands::talipp::talipp_momentum,
            commands::talipp::talipp_volatility,
            commands::talipp::talipp_volume,
            commands::talipp::talipp_specialized,
            // PyPME - Public Market Equivalent calculations
            commands::pypme::pypme_calculate,
            commands::pypme::pypme_verbose,
            commands::pypme::pypme_xpme,
            commands::pypme::pypme_verbose_xpme,
            commands::pypme::pypme_tessa_xpme,
            commands::pypme::pypme_tessa_verbose_xpme,
            // GS-Quant Wrapper Commands
            commands::gs_quant::gs_quant_performance_analysis,
            commands::gs_quant::gs_quant_technical_analysis,
            commands::gs_quant::gs_quant_risk_metrics,
            commands::gs_quant::gs_quant_volatility_surface,
            commands::gs_quant::gs_quant_var_analysis,
            commands::gs_quant::gs_quant_stress_test,
            commands::gs_quant::gs_quant_greeks,
            commands::gs_quant::gs_quant_comprehensive_risk_report,
            commands::gs_quant::gs_quant_portfolio_analytics,
            commands::gs_quant::gs_quant_historical_simulation,
            commands::gs_quant::gs_quant_statistics,
            commands::gs_quant::gs_quant_correlation_analysis,
            commands::gs_quant::gs_quant_backtest,
            commands::gs_quant::gs_quant_basket_backtest,
            commands::gs_quant::gs_quant_instrument_create,
            commands::gs_quant::gs_quant_datetime_utils,

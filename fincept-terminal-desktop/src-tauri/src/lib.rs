...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::database::db_create_margin_block,
            commands::database::db_get_margin_blocks,
            commands::database::db_get_margin_block_by_order,
            commands::database::db_delete_margin_block,
            commands::database::db_get_total_blocked_margin,
            commands::database::db_get_available_margin,
            // Paper Trading Holdings Commands
            commands::database::db_create_holding,
            commands::database::db_get_holdings,
            commands::database::db_get_holding_by_symbol,
            commands::database::db_update_holding,
            commands::database::db_delete_holding,
            commands::database::db_process_t1_settlement,
            // Paper Trading Execution Engine Commands
            commands::database::db_fill_order,
            commands::database::db_get_portfolio_stats,
            commands::database::db_reset_portfolio,
            ...
            commands::stock_paper_trading::stock_paper_trading_get_portfolio,
            commands::stock_paper_trading::stock_paper_trading_create_portfolio,
            commands::stock_paper_trading::stock_paper_trading_place_order,
            commands::stock_paper_trading::stock_paper_trading_modify_order,
            commands::stock_paper_trading::stock_paper_trading_cancel_order,
            commands::stock_paper_trading::stock_paper_trading_get_orders,
            commands::stock_paper_trading::stock_paper_trading_get_order_by_id,
            commands::stock_paper_trading::stock_paper_trading_get_positions,
            commands::stock_paper_trading::stock_paper_trading_get_holdings,
            commands::stock_paper_trading::stock_paper_trading_get_funds,
            commands::stock_paper_trading::stock_paper_trading_get_statistics,
            commands::stock_paper_trading::stock_paper_trading_reset_portfolio,
            commands::stock_paper_trading::stock_paper_trading_convert_position,
            ...
            // Generic Storage Commands (localStorage replacement)

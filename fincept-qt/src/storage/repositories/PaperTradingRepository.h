...
public:
    ...
    std::optional<trading::PtPortfolio>         find_portfolio(const QString& name,
    ...
    Result<QVector<trading::PtOrder>>           get_orders(const QString& portfolio_id,
                                                            const QString& status = {});
    Result<void>                                update_order_fill(const QString& id,
    ...
    std::optional<trading::PtPosition>          find_position(const QString& portfolio_id,
                                                               const QString& symbol,
                                                               const QString& side);
    Result<void>                                update_position(const QString& id,
                                                                 double quantity, double entry_price);
    Result<void>                                update_position_price(const QString& portfolio_id,
                                                                       const QString& symbol,
                                                                       double price);
    ...
    Result<QVector<trading::PtTrade>>           get_trades(const QString& portfolio_id,
                                                            int64_t limit = 100);

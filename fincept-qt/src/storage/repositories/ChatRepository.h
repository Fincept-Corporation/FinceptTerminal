...
public:
    ...
    // Sessions
    Result<ChatSession>              create_session(const QString& title, const QString& provider = {},
                                                     const QString& model = {});
    ...
    // Messages
    Result<void>                     add_message(const QString& session_id, const QString& role,
                                                  const QString& content, const QString& provider = {},
                                                  const QString& model = {}, int tokens = 0);

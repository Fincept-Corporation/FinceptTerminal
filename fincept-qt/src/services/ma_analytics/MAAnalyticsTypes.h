...
inline QStringList module_capabilities(ModuleId id) {
    ...
    case ModuleId::Valuation:
        return {"DCF Analysis", "LBO Modeling (Returns, Model, Debt Schedule, Sensitivity)",
    ...
    case ModuleId::Deals:
        return {"Deal Database & Search", "SEC Filing Scanner (EDGAR)",
                "Auto-Parse Deal Indicators", "Confidence Scoring"};
    ...
    case ModuleId::Fairness:
        return {"Fairness Analysis & Conclusion", "Premium Analysis (Multi-Period)",

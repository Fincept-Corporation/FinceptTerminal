...
WorkspaceDef WorkspaceTemplates::make(const QString& template_id) {
    if (template_id == "equity_trader")
        return equity_trader();
    if (template_id == "crypto_trader")
        return crypto_trader();
    if (template_id == "portfolio_manager")
        return portfolio_manager();
    if (template_id == "research_analyst")
        return research_analyst();
    if (template_id == "macro_economist")

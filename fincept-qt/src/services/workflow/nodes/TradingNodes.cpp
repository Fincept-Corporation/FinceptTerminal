...
void register_trading_nodes(NodeRegistry& registry)
{
    ...
    registry.register_type({
        .type_id = "trading.bracket_order", .display_name = "Bracket Order",
        .category = "Trading", .description = "OCO bracket: entry + stop loss + take profit",
        .icon_text = "T", .accent_color = "#16a34a", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "trading.trailing_stop", .display_name = "Trailing Stop",
        .category = "Trading", .description = "Trailing stop loss order",
        .icon_text = "T", .accent_color = "#16a34a", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "trading.scale_in", .display_name = "Scale In",
        .category = "Trading", .description = "Gradually build position in tranches",
        .icon_text = "T", .accent_color = "#16a34a", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {

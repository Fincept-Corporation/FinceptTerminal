...
void register_file_nodes(NodeRegistry& registry)
{
    registry.register_type({
        .type_id = "file.operations", .display_name = "File Operations",
        .category = "Files", .description = "Read, write, or append to files",
    ...
    registry.register_type({
        .type_id = "file.spreadsheet", .display_name = "Spreadsheet File",
        .category = "Files", .description = "Read/write Excel or CSV files",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "file.binary", .display_name = "Binary File",
        .category = "Files", .description = "Read/write binary files",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "file.convert", .display_name = "Convert to File",
        .category = "Files", .description = "Convert data to a downloadable file format",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
    ...
    registry.register_type({
        .type_id = "file.compress", .display_name = "Compress",
        .category = "Files", .description = "Compress or decompress files",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {

...
void register_data_format_nodes(NodeRegistry& registry)
{
    registry.register_type({
        .type_id = "format.json", .display_name = "JSON",
        .category = "Data Format", .description = "Parse, stringify, or query JSON data",
    ...
    registry.register_type({
        .type_id = "format.xml", .display_name = "XML",
        .category = "Data Format", .description = "Parse or generate XML data",
        .icon_text = "{}", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "format.html_extract", .display_name = "HTML Extract",
        .category = "Data Format", .description = "Extract data from HTML using CSS selectors",
        .icon_text = "{}", .accent_color = "#0891b2", .version = 1,
    ...
    registry.register_type({
        .type_id = "format.compare_datasets", .display_name = "Compare Datasets",
        .category = "Data Format", .description = "Compare two datasets and find differences",
        .icon_text = "{}", .accent_color = "#0891b2", .version = 1,
        .inputs  = {
    ...
    registry.register_type({
        .type_id = "format.csv_parse", .display_name = "CSV Parse",
        .category = "Data Format", .description = "Parse CSV string to structured data",
        .icon_text = "{}", .accent_color = "#0891b2", .version = 1,
    ...
    registry.register_type({
        .type_id = "format.regex_extract", .display_name = "Regex Extract",
        .category = "Data Format", .description = "Extract data using regular expression patterns",
        .icon_text = "{}", .accent_color = "#0891b2", .version = 1,

...
void register_utility_nodes(NodeRegistry& registry)
{
    ...
    registry.register_type({
        ...
        .parameters   = {
            ...
            { "operator", "Operator", "select", "equals", {"equals","not_equals","contains","greater_than","less_than"}, "" },
    ...
    registry.register_type({
        ...
        .outputs      = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters   = {
            { "operation", "Operation", "select", "split", {"split","concatenate","flatten","unique","reverse","shuffle"}, "" },
    ...
    registry.register_type({
        ...
        .outputs      = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters   = {
            { "operation", "Operation", "select", "sha256", {"sha256","md5","base64_encode","base64_decode","hmac_sha256"}, "" },
    ...
    registry.register_type({
        ...
        .outputs      = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters   = {
            { "event_type", "Event", "select", "volatility_spike", {"volatility_spike","circuit_breaker","market_open","market_close","earnings_release"}, "" },
    ...
    registry.register_type({
        .type_id = "transform.pivot", .display_name = "Pivot Table",
        .category = "Data Transform", .description = "Pivot rows to columns",
        .icon_text = "~", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "transform.normalize", .display_name = "Normalize",
        .category = "Data Transform", .description = "Min-max or z-score normalization",
        .icon_text = "~", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "transform.rolling_window", .display_name = "Rolling Window",
        .category = "Data Transform", .description = "Rolling calculations (MA, sum, std, etc.)",
        .icon_text = "~", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "transform.lag", .display_name = "Lag / Lead",
        .category = "Data Transform", .description = "Time-shift data by N periods",
        .icon_text = "~", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "transform.resample", .display_name = "Resample",
        .category = "Data Transform", .description = "Change time frequency (1min→1h, daily→weekly)",
        .icon_text = "~", .accent_color = "#0891b2", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
            { "target_freq", "Target Frequency", "select", "1h", {"1m","5m","15m","1h","4h","1d","1w","1M"}, "" },
    ...
    registry.register_type({
        .type_id = "utility.cache_node", .display_name = "Cache",
        .category = "Utilities", .description = "Cache node output with TTL to avoid redundant computation",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "utility.delay_node", .display_name = "Delay",
        .category = "Utilities", .description = "Configurable delay between nodes",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "utility.log_node", .display_name = "Log",
        .category = "Utilities", .description = "Log data to console/file for debugging",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "utility.assert_node", .display_name = "Assert",
        .category = "Utilities", .description = "Assert a condition — fail workflow if false",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "utility.template_render", .display_name = "Template",
        .category = "Utilities", .description = "Render string template with {{variable}} substitution",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {

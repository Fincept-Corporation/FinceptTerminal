...
void register_market_data_nodes(NodeRegistry& registry)
{
    ...
    registry.register_type({
        ...
        .parameters   = {
            { "indicator", "Indicator", "select", "GDP", {"GDP","CPI","UNEMPLOYMENT","INTEREST_RATE","INFLATION","RETAIL_SALES"}, "" },
    ...
    registry.register_type({
        .type_id = "market.get_options_chain", .display_name = "Options Chain",
        .category = "Market Data", .description = "Fetch options chain with greeks",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
    ...
    registry.register_type({
        .type_id = "market.get_crypto_price", .display_name = "Crypto Price",
        .category = "Market Data", .description = "Real-time cryptocurrency prices",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::PriceData }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "market.get_forex_rate", .display_name = "Forex Rate",
        .category = "Market Data", .description = "Foreign exchange rates",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::PriceData }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "market.screener", .display_name = "Stock Screener",
        .category = "Market Data", .description = "Screen stocks by financial criteria",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        ...
        .parameters = {
            ...
            { "sector", "Sector", "select", "any", {"any","technology","healthcare","finance","energy","consumer","industrial","utilities","materials","real_estate"}, "" },
    ...
    registry.register_type({
        .type_id = "market.insider_trades", .display_name = "Insider Trades",
        .category = "Market Data", .description = "Fetch insider trading activity (Form 4 filings)",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    registry.register_type({
        .type_id = "market.sec_filings", .display_name = "SEC Filings",
        .category = "Market Data", .description = "Fetch SEC filings (10-K, 10-Q, 8-K, etc.)",
        .icon_text = "$", .accent_color = "#2563eb", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
            { "symbol", "Symbol", "string", "", {}, "Company ticker", true },
            { "filing_type", "Filing Type", "select", "10-K", {"10-K","10-Q","8-K","13F","S-1","DEF 14A","all"}, "" },

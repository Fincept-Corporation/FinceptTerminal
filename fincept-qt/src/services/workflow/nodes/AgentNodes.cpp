...
void register_agent_nodes(NodeRegistry& registry) {
    registry.register_type({
        .type_id = "agent.single",
        .display_name = "AI Agent",
        .category = "Agents",
        .description = "Execute a single AI agent with a prompt",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
        ...
        .parameters =
            {
                {"agent_type",
                 ...
                 "select",
                 "general",
                 {"general", "geopolitics", "economic", "hedge_fund", "trader", "investor", "deep_research"},
                 "",
                 true},
                ...
                {"model",
                 ...
                 "select",
                 "auto",
                 {"auto", "claude-sonnet-4-5-20250514", "claude-3-haiku-20240307", "gpt-4o", "gpt-4o-mini"},
                 ""},
    ...
    registry.register_type({
        .type_id = "agent.mediator",
        .display_name = "Agent Mediator",
        .category = "Agents",
        .description = "Coordinate multiple agents (sequential, parallel, consensus)",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
        .inputs =
    ...
    registry.register_type({
        .type_id = "agent.summarizer",
        .display_name = "Summarizer",
        .category = "Agents",
        .description = "Summarize long text, data, or documents",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
    ...
    registry.register_type({
        .type_id = "agent.classifier",
        .display_name = "Classifier",
        .category = "Agents",
        .description = "Classify text (bullish/bearish/neutral, sector, topic)",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
        .inputs = {{"input_0", "Text In", PortDirection::Input, ConnectionType::Main}},
    ...
    registry.register_type({
        .type_id = "agent.code_generator",
        .display_name = "Code Generator",
        .category = "Agents",
        .description = "Generate Python/SQL code from natural language",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
        .inputs = {{"input_0", "Context", PortDirection::Input, ConnectionType::Main}},
    ...
    registry.register_type({
        .type_id = "agent.rag_query",
        .display_name = "RAG Query",
        .category = "Agents",
        .description = "Query against document embeddings (RAG)",
        .icon_text = "AI",
        .accent_color = "#7c3aed",
        .version = 1,
        .inputs = {{"input_0", "Context", PortDirection::Input, ConnectionType::Main}},

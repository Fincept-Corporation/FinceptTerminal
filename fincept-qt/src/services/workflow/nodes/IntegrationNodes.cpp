...
void register_integration_nodes(NodeRegistry& registry)
{
    ...
    registry.register_type({
        .type_id = "mcp.tool_call", .display_name = "MCP Tool",
        .category = "MCP Tools", .description = "Call any registered MCP server tool",
        .icon_text = "M", .accent_color = "#6366f1", .version = 1,
    ...
    // ── Python Script ──────────────────────────────────────────────
    registry.register_type({
        .type_id = "mcp.python_script", .display_name = "Python Script",
        .category = "MCP Tools", .description = "Run a specific Python script from scripts/ directory",
        .icon_text = "M", .accent_color = "#6366f1", .version = 1,
    ...
    // ── Push Notification ──────────────────────────────────────────
    registry.register_type({
        .type_id = "notify.push", .display_name = "Push Notification",
        .category = "Notifications", .description = "Send mobile push notification",
        .icon_text = "@", .accent_color = "#ca8a04", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
    ...
    // ── Audio Alert ────────────────────────────────────────────────
    registry.register_type({
        .type_id = "notify.audio_alert", .display_name = "Audio Alert",
        .category = "Notifications", .description = "Play a sound alert on the local machine",
        .icon_text = "@", .accent_color = "#ca8a04", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    // ── PDF Generate ───────────────────────────────────────────────
    registry.register_type({
        .type_id = "file.pdf_generate", .display_name = "PDF Report",
        .category = "Files", .description = "Generate PDF report from data",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
    ...
    // ── Image Chart ────────────────────────────────────────────────
    registry.register_type({
        .type_id = "file.image_chart", .display_name = "Chart Image",
        .category = "Files", .description = "Generate chart as PNG image",
        .icon_text = "F", .accent_color = "#525252", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {
            { "chart_type", "Chart Type", "select", "line", {"line","bar","candlestick","scatter","pie","heatmap"}, "" },
    ...
    // ── Google Sheets ──────────────────────────────────────────────
    registry.register_type({
        .type_id = "utility.google_sheets", .display_name = "Google Sheets",
        .category = "Utilities", .description = "Read/write Google Sheets",
    ...
    // ── Generic API Call ───────────────────────────────────────────
    registry.register_type({
        .type_id = "utility.api_call", .display_name = "API Call",
        .category = "Utilities", .description = "REST API call with authentication",
        .icon_text = "#", .accent_color = "#808080", .version = 1,
        .inputs  = {{ "input_0", "Data In", PortDirection::Input, ConnectionType::Main }},
        .outputs = {{ "output_main", "Main", PortDirection::Output, ConnectionType::Main }},
        .parameters = {

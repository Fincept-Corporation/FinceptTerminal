// PortfolioManagementTools.cpp — Full portfolio CRUD MCP tools
// Covers: portfolios, assets, transactions, snapshots via PortfolioRepository
...
static constexpr const char* TAG = "PortfolioMgmtTools";

std::vector<ToolDef> get_portfolio_management_tools() {
    ...
    // ── create_portfolio ────────────────────────────────────────────────
    {
        ...
        t.description = "Create a new investment portfolio.";
        t.category = "portfolio";
        t.input_schema.properties =
    ...
    // ── get_portfolio_assets ────────────────────────────────────────────
    {
        ...
        t.description = "Get all asset holdings for a portfolio.";
        t.category = "portfolio";
        t.input_schema.properties =
            QJsonObject{{"portfolio_id", QJsonObject{{"type", "string"}, {"description", "Portfolio ID"}}}};
        t.input_schema.required = {"portfolio_id"};
    ...
    // ── remove_portfolio_asset ──────────────────────────────────────────
    {
        ...
        t.description = "Remove an asset/holding from a portfolio by symbol.";
        t.category = "portfolio";
        t.input_schema.properties =
            QJsonObject{{"portfolio_id", QJsonObject{{"type", "string"}, {"description", "Portfolio ID"}}},

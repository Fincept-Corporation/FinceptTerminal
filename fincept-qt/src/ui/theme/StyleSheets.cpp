...
QString crypto_trading_styles() {
    return QString(
        ...
        "#cryptoModeBtn[mode=\"paper\"] { background: rgba(22,163,74,0.1); color: %15; border: 1px solid #14532d; }"
        "#cryptoModeBtn[mode=\"live\"] { background: rgba(220,38,38,0.1); color: %11; border: 1px solid #7f1d1d; }"

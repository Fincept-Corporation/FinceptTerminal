...
NavigationBar::NavigationBar(QWidget* parent) : QWidget(parent) {
    ...
    hl->setContentsMargins(14,0,14,0); hl->setSpacing(0);
    ...
    logout_btn->setFixedHeight(24); logout_btn->setCursor(Qt::PointingHandCursor);
    ...
    connect(&auth::AuthManager::instance(), &auth::AuthManager::auth_state_changed,
            this, &NavigationBar::refresh_user_display);
...
void NavigationBar::refresh_user_display() {
    ...
    if (!s.authenticated) { user_label_->setText("---"); credits_label_->setText("---"); plan_label_->setText("---"); return; }
    ...
    credits_label_->setStyleSheet(QString("color:%1;font-size:13px;background:transparent;font-family:'Consolas',monospace;")

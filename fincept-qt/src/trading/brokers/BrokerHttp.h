...
public:
    ...
    BrokerHttpResponse get(const QString& url,
                            const QMap<QString, QString>& headers = {});

    BrokerHttpResponse post_json(const QString& url,
                                  const QJsonObject& payload,
                                  const QMap<QString, QString>& headers = {});

    BrokerHttpResponse put_json(const QString& url,
                                 const QJsonObject& payload,
                                 const QMap<QString, QString>& headers = {});

    BrokerHttpResponse del(const QString& url,
                            const QMap<QString, QString>& headers = {},
                            const QJsonObject& payload = {});

    // Form-urlencoded POST (Zerodha, some Indian brokers)
    BrokerHttpResponse post_form(const QString& url,
...
private:
    BrokerHttp() = default;
    BrokerHttpResponse execute(const QString& method, const QString& url,

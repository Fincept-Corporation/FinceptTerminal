...
static auto& repo() { return PaperTradingRepository::instance(); }

// ============================================================================
// Portfolio Operations
// ============================================================================

PtPortfolio pt_create_portfolio(const QString& name, double balance,
                                 const QString& currency, double leverage,
                                 const QString& margin_mode, double fee_rate,
    ...
    if (r.is_err()) throw std::runtime_error(r.error());
    return p;
}
...
PtOrder pt_place_order(const QString& portfolio_id, const QString& symbol,
                        const QString& side, const QString& order_type,
    ...
    if (!reduce_only) {
        ...
        double required = quantity * ref / portfolio.leverage;
...
PtTrade pt_fill_order(const QString& order_id, double fill_price,
    ...
    if (or1.is_err()) throw std::runtime_error(or1.error());
...
void pt_update_position_price(const QString& portfolio_id,

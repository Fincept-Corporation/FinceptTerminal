// src/screens/gov_data/GovDataCanadaPanel.h
// Canada Open Government Data panel (open.canada.ca / CKAN).
...
class GovDataCanadaPanel : public QWidget {
    Q_OBJECT
  public:
    explicit GovDataCanadaPanel(QWidget* parent = nullptr);
  ...
  private:
    ...
    static constexpr const char* kScript = "canada_gov_api.py";
    static constexpr const char* kColor = "#EF4444";

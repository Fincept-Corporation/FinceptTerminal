...
static const QString kUKStyle = QString(
    ...
    "#govTabBtn:checked { background:rgba(16,185,129,0.12); color:#10B981;"
    ...
    "#govPopularBtn { background:transparent; color:#10B981; border:1px solid #10B981;"
    "  font-size:10px; font-weight:700; padding:4px 10px; }"
    "#govPopularBtn:hover { background:rgba(16,185,129,0.12); }"

    "#govFetchBtn { background:#10B981; color:#080808; border:none;"
    "  font-size:10px; font-weight:700; padding:4px 14px; }"
    "#govFetchBtn:hover { background:#0ea572; }"
    ...
    "#govSearch:focus { border-bottom:1px solid #10B981; }"

...
QString PortfolioSectorPanel::infer_sector(const QString& sym) {
    ...
    static const QHash<QString, QString> known = {
        ...
        {"IBM","Technology"},{"AMAT","Technology"},{"MU","Technology"},{"LRCX","Technology"},
        {"KLAC","Technology"},{"SNPS","Technology"},{"CDNS","Technology"},{"ADI","Technology"},
        {"MCHP","Technology"},{"NXPI","Technology"},{"STX","Technology"},{"WDC","Technology"},
        {"HPQ","Technology"},{"DELL","Technology"},{"ACN","Technology"},{"INTU","Technology"},
        {"NOW","Technology"},{"SNOW","Technology"},{"DDOG","Technology"},{"ZS","Technology"},
        {"CRWD","Technology"},{"PANW","Technology"},{"FTNT","Technology"},{"NET","Technology"},
        {"OKTA","Technology"},{"MDB","Technology"},{"TEAM","Technology"},{"ATLASSIAN","Technology"},
        {"SHOP","Technology"},{"UBER","Technology"},{"LYFT","Technology"},{"ABNB","Technology"},
        {"PLTR","Technology"},{"RBLX","Technology"},{"U","Technology"},{"TWLO","Technology"},
        {"ZM","Technology"},{"DOCUSIGN","Technology"},{"COIN","Technology"},{"HOOD","Technology"},
        {"APP","Technology"},{"APPF","Technology"},{"GTLB","Technology"},{"PATH","Technology"},
        // Communication
        {"NFLX","Communication"},{"DIS","Communication"},{"CMCSA","Communication"},
        {"T","Communication"},{"VZ","Communication"},{"TMUS","Communication"},
        {"CHTR","Communication"},{"WBD","Communication"},{"PARA","Communication"},
        {"FOXA","Communication"},{"FOX","Communication"},{"MTCH","Communication"},
        {"PINS","Communication"},{"SNAP","Communication"},{"RDDT","Communication"},
        {"SPOT","Communication"},{"LYV","Communication"},{"WMG","Communication"},
        // Consumer Cyclical
        ...
        {"GM","Consumer Cyclical"},{"F","Consumer Cyclical"},{"STLA","Consumer Cyclical"},
        ...
        {"ROST","Consumer Cyclical"},{"TJX","Consumer Cyclical"},{"EBAY","Consumer Cyclical"},
        {"ETSY","Consumer Cyclical"},{"W","Consumer Cyclical"},{"RH","Consumer Cyclical"},
        {"DHI","Consumer Cyclical"},{"LEN","Consumer Cyclical"},{"PHM","Consumer Cyclical"},
        {"TOL","Consumer Cyclical"},{"MGM","Consumer Cyclical"},{"WYNN","Consumer Cyclical"},
        {"LVS","Consumer Cyclical"},{"CCL","Consumer Cyclical"},{"RCL","Consumer Cyclical"},
        {"NCLH","Consumer Cyclical"},{"UAL","Consumer Cyclical"},{"DAL","Consumer Cyclical"},
        {"AAL","Consumer Cyclical"},{"LUV","Consumer Cyclical"},{"EXPE","Consumer Cyclical"},
        // Consumer Defensive
        ...
        {"MO","Consumer Defensive"},{"MDLZ","Consumer Defensive"},{"KHC","Consumer Defensive"},
        {"GIS","Consumer Defensive"},{"K","Consumer Defensive"},{"CPB","Consumer Defensive"},
        {"SJM","Consumer Defensive"},{"HSY","Consumer Defensive"},{"CAG","Consumer Defensive"},
        {"CL","Consumer Defensive"},{"CHD","Consumer Defensive"},{"KMB","Consumer Defensive"},
        {"EL","Consumer Defensive"},{"ULTA","Consumer Defensive"},
        // Healthcare
        {"JNJ","Healthcare"},{"UNH","Healthcare"},{"LLY","Healthcare"},{"ABBV","Healthcare"},
        {"MRK","Healthcare"},{"PFE","Healthcare"},{"TMO","Healthcare"},{"ABT","Healthcare"},
        {"DHR","Healthcare"},{"BMY","Healthcare"},{"AMGN","Healthcare"},{"GILD","Healthcare"},
        {"ISRG","Healthcare"},{"SYK","Healthcare"},{"BSX","Healthcare"},{"MDT","Healthcare"},
        {"BDX","Healthcare"},{"EW","Healthcare"},{"DXCM","Healthcare"},{"ALGN","Healthcare"},
        {"HCA","Healthcare"},{"HUM","Healthcare"},{"CI","Healthcare"},{"CVS","Healthcare"},
        {"MCK","Healthcare"},{"ABC","Healthcare"},{"CAH","Healthcare"},{"BIIB","Healthcare"},
        {"REGN","Healthcare"},{"VRTX","Healthcare"},{"ILMN","Healthcare"},{"MRNA","Healthcare"},
        {"BNTX","Healthcare"},{"IQV","Healthcare"},{"A","Healthcare"},{"WAT","Healthcare"},
        // Financial Services
        {"JPM","Financial Services"},{"BAC","Financial Services"},{"WFC","Financial Services"},
        {"GS","Financial Services"},{"MS","Financial Services"},{"C","Financial Services"},
        {"AXP","Financial Services"},{"BLK","Financial Services"},{"SCHW","Financial Services"},
        {"BRK-B","Financial Services"},{"BRK-A","Financial Services"},
        {"V","Financial Services"},{"MA","Financial Services"},{"PYPL","Financial Services"},
        {"SQ","Financial Services"},{"FIS","Financial Services"},{"FI","Financial Services"},
        {"GPN","Financial Services"},{"ALLY","Financial Services"},{"COF","Financial Services"},
        {"DFS","Financial Services"},{"USB","Financial Services"},{"PNC","Financial Services"},
        {"TFC","Financial Services"},{"MTB","Financial Services"},{"RF","Financial Services"},
        {"KEY","Financial Services"},{"CFG","Financial Services"},{"FITB","Financial Services"},
        {"HBAN","Financial Services"},{"STT","Financial Services"},{"BK","Financial Services"},
        {"ICE","Financial Services"},{"CME","Financial Services"},{"CBOE","Financial Services"},
        {"NDAQ","Financial Services"},{"MCO","Financial Services"},{"SPGI","Financial Services"},
        {"MMC","Financial Services"},{"AJG","Financial Services"},{"AON","Financial Services"},
        {"PRU","Financial Services"},{"MET","Financial Services"},{"AFL","Financial Services"},
        {"ALL","Financial Services"},{"PGR","Financial Services"},{"CB","Financial Services"},
        {"TRV","Financial Services"},{"HIG","Financial Services"},{"AIG","Financial Services"},
        // Energy
        {"XOM","Energy"},{"CVX","Energy"},{"COP","Energy"},{"EOG","Energy"},
        {"SLB","Energy"},{"PXD","Energy"},{"OXY","Energy"},{"MPC","Energy"},
        {"PSX","Energy"},{"VLO","Energy"},{"WMB","Energy"},{"KMI","Energy"},
        {"ET","Energy"},{"EPD","Energy"},{"BKR","Energy"},{"HAL","Energy"},
        {"DVN","Energy"},{"FANG","Energy"},{"HES","Energy"},{"APA","Energy"},
        {"MRO","Energy"},{"NOG","Energy"},
        // Utilities
        {"NEE","Utilities"},{"DUK","Utilities"},{"SO","Utilities"},{"D","Utilities"},
        {"AEP","Utilities"},{"EXC","Utilities"},{"XEL","Utilities"},{"ES","Utilities"},
        {"WEC","Utilities"},{"AWK","Utilities"},{"ED","Utilities"},{"PPL","Utilities"},
        {"FE","Utilities"},{"EIX","Utilities"},{"PEG","Utilities"},{"ETR","Utilities"},
        {"CMS","Utilities"},{"ATO","Utilities"},{"NI","Utilities"},{"OGE","Utilities"},
        // Industrials
        {"GE","Industrials"},{"HON","Industrials"},{"UPS","Industrials"},{"BA","Industrials"},
        {"CAT","Industrials"},{"DE","Industrials"},{"LMT","Industrials"},{"RTX","Industrials"},
        ...
        {"ROK","Industrials"},{"DOV","Industrials"},{"AME","Industrials"},{"IEX","Industrials"},
        {"FDX","Industrials"},{"CSX","Industrials"},{"UNP","Industrials"},{"NSC","Industrials"},
        {"DAL","Industrials"},{"WM","Industrials"},{"RSG","Industrials"},{"GWW","Industrials"},
        {"FAST","Industrials"},{"GNRC","Industrials"},{"IR","Industrials"},{"XYL","Industrials"},
        // Real Estate
        ...
        {"DLR","Real Estate"},{"VTR","Real Estate"},{"AVB","Real Estate"},{"EQR","Real Estate"},
        {"MAA","Real Estate"},{"UDR","Real Estate"},{"ESS","Real Estate"},{"CPT","Real Estate"},
        {"NNN","Real Estate"},{"STAG","Real Estate"},{"ARE","Real Estate"},{"BXP","Real Estate"},
        // Basic Materials
        {"LIN","Basic Materials"},{"APD","Basic Materials"},{"SHW","Basic Materials"},
        {"ECL","Basic Materials"},{"DD","Basic Materials"},{"DOW","Basic Materials"},
        {"LYB","Basic Materials"},{"CF","Basic Materials"},{"MOS","Basic Materials"},
        {"NEM","Basic Materials"},{"FCX","Basic Materials"},{"AA","Basic Materials"},
        {"NUE","Basic Materials"},{"STLD","Basic Materials"},{"CLF","Basic Materials"},
        {"X","Basic Materials"},{"RS","Basic Materials"},
        // ETFs / Index funds
        {"SPY","ETF/Index"},{"QQQ","ETF/Index"},{"IWM","ETF/Index"},{"DIA","ETF/Index"},
        {"VTI","ETF/Index"},{"VOO","ETF/Index"},{"VEA","ETF/Index"},{"VWO","ETF/Index"},
        {"GLD","ETF/Index"},{"SLV","ETF/Index"},{"IAU","ETF/Index"},{"USO","ETF/Index"},
        {"TLT","ETF/Index"},{"IEF","ETF/Index"},{"SHY","ETF/Index"},{"AGG","ETF/Index"},
        {"BND","ETF/Index"},{"HYG","ETF/Index"},{"LQD","ETF/Index"},{"EMB","ETF/Index"},
        {"XLK","ETF/Index"},{"XLF","ETF/Index"},{"XLV","ETF/Index"},{"XLE","ETF/Index"},
        {"XLI","ETF/Index"},{"XLY","ETF/Index"},{"XLP","ETF/Index"},{"XLU","ETF/Index"},
        {"XLB","ETF/Index"},{"XLRE","ETF/Index"},{"XLC","ETF/Index"},
        {"ARKK","ETF/Index"},{"ARKW","ETF/Index"},{"ARKG","ETF/Index"},
        // Crypto
        {"BTC-USD","Cryptocurrency"},{"ETH-USD","Cryptocurrency"},{"BNB-USD","Cryptocurrency"},
        {"SOL-USD","Cryptocurrency"},{"XRP-USD","Cryptocurrency"},{"ADA-USD","Cryptocurrency"},
        {"AVAX-USD","Cryptocurrency"},{"DOGE-USD","Cryptocurrency"},{"DOT-USD","Cryptocurrency"},
        {"MATIC-USD","Cryptocurrency"},{"LINK-USD","Cryptocurrency"},{"LTC-USD","Cryptocurrency"},
        {"UNI-USD","Cryptocurrency"},{"ATOM-USD","Cryptocurrency"},{"NEAR-USD","Cryptocurrency"},
        {"ALGO-USD","Cryptocurrency"},{"XLM-USD","Cryptocurrency"},{"VET-USD","Cryptocurrency"},
        ...
        {"KOTAKBANK.NS","Financial Services"},{"BAJFINANCE.NS","Financial Services"},
        {"WIPRO.NS","Technology"},{"HCLTECH.NS","Technology"},{"TECHM.NS","Technology"},
        {"LTIM.NS","Technology"},{"PERSISTENT.NS","Technology"},
        ...
        {"TITAN.NS","Consumer Cyclical"},{"MARUTI.NS","Consumer Cyclical"},
        {"TATAMOTORS.NS","Consumer Cyclical"},{"M&M.NS","Consumer Cyclical"},
        {"BAJAJ-AUTO.NS","Consumer Cyclical"},{"HEROMOTOCO.NS","Consumer Cyclical"},
        {"ADANIENT.NS","Industrials"},{"ADANIPORTS.NS","Industrials"},
        {"POWERGRID.NS","Utilities"},{"NTPC.NS","Utilities"},{"ONGC.NS","Energy"},
        {"BPCL.NS","Energy"},{"IOC.NS","Energy"},{"COAL.NS","Basic Materials"},
        {"JSWSTEEL.NS","Basic Materials"},{"TATASTEEL.NS","Basic Materials"},
        {"HINDALCO.NS","Basic Materials"},{"GRASIM.NS","Basic Materials"},
        {"ULTRACEMCO.NS","Basic Materials"},{"ACC.NS","Basic Materials"},
        {"LT.NS","Industrials"},{"SIEMENS.NS","Industrials"},{"ABB.NS","Industrials"},
        {"BHARTIARTL.NS","Communication"},{"IDEA.NS","Communication"},
    };
    ...
    // Bond ETF pattern
    if (s.startsWith("TLT") || s.startsWith("AGG") || s.startsWith("BND") ||
        s.contains("BOND") || s.contains("TREAS"))
        return "Fixed Income";

    // Commodity pattern
    if (s.contains("OIL") || s.contains("GOLD") || s.contains("SILV") ||
        s.contains("CORN") || s.contains("WHEAT"))
        return "Commodities";
...
void PortfolioSectorPanel::build_ui() {
    ...
    corr_note->setStyleSheet(
        QString("color:%1; font-size:8px;").arg(ui::colors::TEXT_TERTIARY));
...
void PortfolioSectorPanel::update_correlation() {
    ...
    for (int i = 0; i < n; ++i) {
        ...
        lbl->setStyleSheet(
            QString("color:%1; font-size:7px; font-weight:700;")
                .arg(ui::colors::TEXT_SECONDARY));

...
inline QString category_label(Category c) {
    switch (c) {
        case Category::Database:        return "Databases";
        case Category::Api:             return "APIs";
        case Category::File:            return "File Sources";
        case Category::Streaming:       return "Streaming";
        case Category::Cloud:           return "Cloud Storage";
        case Category::TimeSeries:      return "Time Series";
        case Category::MarketData:      return "Market Data";
        case Category::SearchAnalytics: return "Search & Analytics";
        case Category::DataWarehouse:   return "Data Warehouses";
    }
    return "Other";
}

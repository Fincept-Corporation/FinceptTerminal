...
static QVector<ConnectorConfig> search_warehouse_configs() {
    return {
        // ── Search & Analytics ──
        {"elasticsearch", "Elasticsearch", "elasticsearch", Category::SearchAnalytics, "E", "#005571",
         "Distributed search and analytics engine", true, false,
        ...
        {"opensearch", "OpenSearch", "opensearch", Category::SearchAnalytics, "O", "#003B5C",
         "Open-source fork of Elasticsearch", true, false,
         {{"node","Node URL",FieldType::Url,"https://localhost:9200",true,"",{}},
          {"username","Username",FieldType::Text,"admin",false,"",{}},
          {"password","Password",FieldType::Password,"",false,"",{}}}},

        {"solr", "Apache Solr", "solr", Category::SearchAnalytics, "S", "#D9411E",
         "Enterprise search platform", true, false,
         {{"host","Host",FieldType::Url,"http://localhost:8983/solr",true,"",{}},
          {"collection","Collection",FieldType::Text,"my-collection",false,"",{}}}},

        {"algolia", "Algolia", "algolia", Category::SearchAnalytics, "A", "#003DFF",
         "Search-as-a-Service platform", true, true,
         {{"appId","Application ID",FieldType::Text,"your-app-id",true,"",{}},
          {"apiKey","API Key",FieldType::Password,"your-api-key",true,"",{}},
          {"index","Default Index",FieldType::Text,"my-index",false,"",{}}}},

        {"meilisearch", "MeiliSearch", "meilisearch", Category::SearchAnalytics, "M", "#FF5CAA",
         "Fast, open-source search engine", true, true,
         {{"host","Host",FieldType::Url,"http://localhost:7700",true,"",{}},
          {"apiKey","API Key",FieldType::Password,"your-master-key",true,"",{}},
          {"index","Default Index",FieldType::Text,"my-index",false,"",{}}}},

        // ── Data Warehouses ──
        {"bigquery", "Google BigQuery", "bigquery", Category::DataWarehouse, "B", "#4285F4",
         "Google Cloud data warehouse", true, true,
        ...
        {"redshift", "Amazon Redshift", "redshift", Category::DataWarehouse, "R", "#8C4FFF",
         "AWS cloud data warehouse", true, true,
        ...
        {"databricks", "Databricks", "databricks", Category::DataWarehouse, "D", "#FF3621",
        ...
        {"synapse", "Azure Synapse", "synapse", Category::DataWarehouse, "S", "#0078D4",
...
static bool registered = [] {
    for (auto& c : search_warehouse_configs()) ConnectorRegistry::instance().add(std::move(c));
    return true;
}();

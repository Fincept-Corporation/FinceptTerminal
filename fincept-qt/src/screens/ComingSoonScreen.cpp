...
ComingSoonScreen::ComingSoonScreen(const QString& tab_name, QWidget* parent)
    : QWidget(parent)
{
    ...
    title->setStyleSheet(
        "color:#d97706;font-size:20px;font-weight:700;background:transparent;"
    ...
    sub->setStyleSheet(
        "color:#525252;font-size:14px;font-weight:700;background:transparent;"
    ...
    desc->setStyleSheet(
        "color:#404040;font-size:13px;background:transparent;"

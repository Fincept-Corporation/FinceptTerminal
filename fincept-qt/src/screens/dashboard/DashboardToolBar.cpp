...
DashboardToolBar::DashboardToolBar(QWidget* parent) : QWidget(parent) {
    ...
    status_text_->setStyleSheet(QString(
        "color: %1; font-size: 11px; font-weight: bold; "
        "background: transparent; font-family: 'Consolas','Courier New',monospace;")
    ...
    clock_label_->setStyleSheet(QString(
    ...
    widget_count_->setStyleSheet(QString(
        "color: %1; font-size: 11px; font-weight: bold; "
        "background: transparent; font-family: 'Consolas','Courier New',monospace;")
        .arg(ui::colors::CYAN));
    ...
    static const auto btn_style = [](const char* border_color, const char* text_color) {
        return QString(
            "QPushButton { background: #111111; border: 1px solid %1; color: %2; "
    ...
    auto btn_primary = QString(
        "QPushButton { background: rgba(217,119,6,0.1); border: 1px solid %1; color: %2; "
        "padding: 0 10px; font-size: 11px; font-weight: bold; "
        "font-family: 'Consolas','Courier New',monospace; }"
    ...
    auto btn_danger = QString(
        "QPushButton { background: rgba(220,38,38,0.1); border: 1px solid #7f1d1d; color: %1; "
        "padding: 0 10px; font-size: 11px; font-weight: bold; "
        "font-family: 'Consolas','Courier New',monospace; }"

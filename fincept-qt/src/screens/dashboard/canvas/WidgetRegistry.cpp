...
WidgetRegistry::WidgetRegistry() {
    ...
    register_widget({"screener", "Stock Screener", "Research", "Filter stocks by fundamentals and technicals", 6, 5, 3, 4,
                     []() { return new widgets::ScreenerWidget; }});
    ...
    register_widget({"risk_metrics", "Risk Metrics", "Portfolio", "Volatility, beta, drawdown, Sharpe ratio", 4, 5, 3, 4,
                     []() { return new widgets::RiskMetricsWidget; }});

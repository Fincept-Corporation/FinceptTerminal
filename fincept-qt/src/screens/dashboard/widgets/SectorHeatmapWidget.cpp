...
QStringList SectorHeatmapWidget::sector_symbols() {
    return {"XLK", "XLV", "XLF", "XLE", "XLY", "XLI",
            "XLB", "XLU", "XLRE", "XLC", "XLP", "SOXX"};
}
...
QMap<QString, QString> SectorHeatmapWidget::sector_labels() {
    return {
        ...
        {"XLC", "Comm. Svc."},    {"XLP", "Consumer Stap."}, {"SOXX", "Semis"},
    };
}

SectorHeatmapWidget::SectorHeatmapWidget(QWidget* parent)
    : BaseWidget("SECTOR HEATMAP", parent)
{

...
static const char* SIDEBAR_SS =
    "QTreeWidget { background: #0a0a0a; color: #808080; border: none;"
...
QWidget* DocsScreen::make_section_panel(const QString& icon, const QString& title,
                                         const QString& body, const QString& accent_color) {
...
QWidget* DocsScreen::make_skill_panel(const QString& beginner, const QString& intermediate,
                                       const QString& advanced, const QString& pro) {
    auto* panel = new QWidget;
    panel->setStyleSheet("background: #0a0a0a; border: 1px solid #1a1a1a;");
    auto* vl = new QVBoxLayout(panel);
    vl->setContentsMargins(0, 0, 0, 0);
...
QWidget* DocsScreen::page_getting_started() {
    ...
    vl->addWidget(make_skill_panel(
        "Explore the Dashboard, set up a watchlist, browse market data",
...
QWidget* DocsScreen::page_keyboard_shortcuts() {
    return make_page("KEYBOARD SHORTCUTS", "Global shortcuts and navigation keys", {
        ...
        {"FILE MENU",
         "New Workspace — Create a fresh workspace layout\n"
        ...
        {"NAVIGATE MENU",
         "Access 30+ screens organized in sub-menus:\n"
        ...
        {"VIEW MENU",
         "Fullscreen (F11) — Use full monitor space\n"
...
QWidget* DocsScreen::page_dashboard() {
    ...
    vl->addWidget(make_skill_panel(
        ...
        "Build specialized layouts for different strategies (day trading vs swing). Use risk metrics + performance together.",
        "Create multi-monitor layouts. Combine dashboard with algo trading feeds. Use economic calendar for event-driven setups."));
...
QWidget* DocsScreen::page_markets() {
    ...
    vl->addWidget(make_skill_panel(
        "Browse the default view. Learn to read green (up) and red (down) color coding.",
...
QWidget* DocsScreen::page_news() {
    return make_page("NEWS", "Real-time news with clustering, sentiment analysis, and deviation monitoring", {
        {"OVERVIEW",
         "The News screen aggregates financial news from multiple sources with intelligent "
        ...
        {"KEY FEATURES",
         "■  Category filtering — All, Markets, Economy, Tech, Crypto, Geopolitics\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Event-driven trading: Monitor breaking news for tradable events\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse headlines, filter by category, read articles\n"
...
QWidget* DocsScreen::page_watchlist() {
    return make_page("WATCHLIST", "Track your favorite instruments with live quotes", {
        {"OVERVIEW",
         "The Watchlist screen lets you create and manage multiple watchlists, each with "
         "live price quotes, change indicators, and quick access to detailed analysis."},
        {"KEY FEATURES",
         "■  Multiple named watchlists (Favorites, Day Trades, Swing, etc.)\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Create your first watchlist with 5-10 symbols you know\n"
...
QWidget* DocsScreen::page_crypto_trading() {
    ...
    vl->addWidget(make_skill_panel(
        ...
        "Run simultaneous positions across exchanges. Use order flow data for scalping. Combine with algo strategies."));
...
QWidget* DocsScreen::page_paper_trading() {
    return make_page("PAPER TRADING", "Risk-free simulated trading engine", {
        {"OVERVIEW",
         "The paper trading engine simulates real market execution with a virtual portfolio. "
        ...
        {"KEY FEATURES",
         "■  Realistic order matching with market simulation\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Strategy testing: Validate a new strategy without risking capital\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Place market orders, understand fills, track basic P&L\n"
...
QWidget* DocsScreen::page_algo_trading() {
    return make_page("ALGO TRADING", "Algorithmic strategy builder, scanner, and deployment", {
        {"OVERVIEW",
         "The Algo Trading screen provides a complete environment for building, testing, "
         "and deploying algorithmic trading strategies. It includes a strategy builder, "
         "market scanner, and deployment dashboard."},
        {"KEY FEATURES",
         "■  Strategy Builder — Define entry/exit rules, position sizing, risk limits\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Momentum strategies: Scan for breakouts, deploy auto-entry\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Explore pre-built strategies, understand entry/exit logic\n"
...
QWidget* DocsScreen::page_backtesting() {
    return make_page("BACKTESTING", "Historical strategy testing with 6 providers and 50+ strategies", {
        {"OVERVIEW",
         "The Backtesting screen lets you test trading strategies against historical data "
         "using multiple backtesting providers. Supports 9 commands, 50+ built-in strategies, "
         "and detailed performance analytics."},
        {"PROVIDERS",
         "■  Backtrader — Python-based, full-featured backtesting engine\n"
...
QWidget* DocsScreen::page_equity_research() {
    return make_page("EQUITY RESEARCH", "Comprehensive stock analysis and fundamental research", {
        {"OVERVIEW",
         "The Equity Research screen provides institutional-grade fundamental analysis tools "
        ...
        {"REAL-WORLD USAGE",
         "■  Due diligence before investing in a new position\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Look up basic financials (revenue, earnings, P/E ratio) for a stock\n"
...
QWidget* DocsScreen::page_surface_analytics() {
    return make_page("SURFACE ANALYTICS", "35 financial surfaces across derivatives, fixed income, FX, credit, and more", {
        {"OVERVIEW",
         "Surface Analytics provides 3D visualization of financial surfaces including "
        ...
        {"REAL-WORLD USAGE",
         "■  Options trading: Analyze vol surface for mispriced options\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: View pre-built surfaces, understand 3D visualization axes\n"
...
QWidget* DocsScreen::page_derivatives() {
    return make_page("DERIVATIVES PRICING", "Bond, equity option, FX option, swap, and CDS pricing", {
        {"OVERVIEW",
         "The Derivatives screen provides pricing models for major derivative types using "
         "embedded Python analytics. Supports bonds, equity options, FX options, interest "
         "rate swaps, and credit default swaps."},
        {"SUPPORTED INSTRUMENTS",
         "■  Bonds — Price, yield, duration, convexity, spread\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Options traders: Price options, calculate Greeks, find mispricing\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Price a simple call option with Black-Scholes, understand Greeks\n"
...
QWidget* DocsScreen::page_portfolio() {
    return make_page("PORTFOLIO", "Multi-portfolio management with analytics and AI agent", {
        {"OVERVIEW",
         "The Portfolio screen supports multiple portfolios with holdings tracking, performance "
         "analytics, sector heatmap, historical chart, blotter, and an AI agent panel for "
         "intelligent portfolio insights."},
        {"KEY FEATURES",
         "■  Multiple named portfolios with separate tracking\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Track your actual brokerage positions with real-time P&L\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Create a portfolio, add holdings, track basic P&L\n"
...
QWidget* DocsScreen::page_ma_analytics() {
    return make_page("M&A ANALYTICS", "Merger and acquisition analysis tools", {
        {"OVERVIEW",
         "The M&A Analytics screen provides tools for analyzing mergers, acquisitions, "
         "and corporate actions including deal comparison, accretion/dilution analysis, "
         "and precedent transaction databases."},
        {"KEY FEATURES",
         "■  Deal screen — Browse recent and historical M&A transactions\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Investment banking: Model potential acquisition targets\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse recent deals, understand deal structure basics\n"
...
QWidget* DocsScreen::page_ai_quant_lab() {
    return make_page("AI QUANT LAB", "18-module quantitative research platform with ML, factor discovery, and RL trading", {
        {"OVERVIEW",
         "The AI Quant Lab is a comprehensive quantitative research environment with 18 modules "
         "covering machine learning, factor discovery, high-frequency trading, reinforcement "
         "learning, and advanced statistical methods."},
        {"MODULES (18)",
         "PREDICTION: ML price prediction, time series forecasting\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Quant research: Discover new alpha factors from alternative data\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Explore pre-built modules, run demo predictions on sample data\n"
...
QWidget* DocsScreen::page_quantlib() {
    return make_page("QUANTLIB SUITE", "18 quantitative analysis modules with 590+ endpoints", {
        {"OVERVIEW",
         "The QuantLib Suite provides access to 590+ quantitative analysis endpoints organized "
        ...
        {"MODULES (18)",
         "■  Core — Fundamental quantitative operations\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Quantitative analyst: Price complex derivatives, calibrate models\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Use the Statistics module for basic data analysis\n"
...
QWidget* DocsScreen::page_ai_chat() {
    return make_page("AI CHAT", "AI-powered financial assistant", {
        {"OVERVIEW",
         "The AI Chat provides a conversational interface powered by large language models "
        ...
        {"REAL-WORLD USAGE",
         "■  Quick analysis: \"What's driving NVDA today?\"\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Ask basic market questions, get explanations of financial concepts\n"
...
QWidget* DocsScreen::page_agent_config() {
    return make_page("AGENT STUDIO", "Configure and manage AI agents, teams, and workflows", {
        {"OVERVIEW",
         "The Agent Studio (Agent Config) provides an 8-view interface for creating, "
         "managing, and orchestrating AI agents with specialized financial capabilities."},
        {"VIEWS (8)",
         "■  Agents — Browse and manage configured agents\n"
        ...
        {"AGENT TYPES",
         "■  Geopolitics Agent — Monitors global events, conflict analysis\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse pre-configured agents, chat with the general assistant\n"
...
QWidget* DocsScreen::page_alpha_arena() {
    return make_page("ALPHA ARENA", "Competitive alpha research and strategy ranking", {
        {"OVERVIEW",
         "Alpha Arena is a competitive environment where trading strategies are ranked "
         "by performance. Submit strategies, compare against peers, and discover new "
         "alpha sources through community insights."},
        {"KEY FEATURES",
         "■  Strategy leaderboard with real-time rankings\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Benchmark your strategies against others\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse the leaderboard, study top strategies\n"
...
QWidget* DocsScreen::page_dbnomics() {
    return make_page("DBNOMICS", "Access 100+ data providers with 500K+ economic datasets", {
        {"OVERVIEW",
         "DBnomics provides access to the world's largest open economic database. Browse "
        ...
        {"KEY FEATURES",
         "■  Provider browser — 100+ statistical agencies and central banks\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Macro research: GDP growth, inflation, employment data by country\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse providers, look up US GDP or inflation data\n"
...
QWidget* DocsScreen::page_economics() {
    return make_page("ECONOMICS", "Macroeconomic data and analysis tools", {
        {"OVERVIEW",
         "The Economics screen provides comprehensive macroeconomic data visualization "
         "and analysis tools for tracking economic indicators, central bank policies, "
         "and global economic trends."},
        {"KEY FEATURES",
         "■  Economic indicators dashboard — GDP, CPI, unemployment, PMI\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Macro trading: Position ahead of rate decisions\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Check upcoming economic events, understand key indicators\n"
...
QWidget* DocsScreen::page_akshare() {
    return make_page("AKSHARE DATA", "Chinese and Asian market data via AkShare", {
        {"OVERVIEW",
         "AkShare provides access to Chinese financial market data including A-shares, "
         "Hong Kong stocks, Chinese futures, and macro data from Chinese statistical agencies."},
        {"KEY FEATURES",
         "■  A-Share market data — SSE, SZSE listed companies\n"
        ...
        {"REAL-WORLD USAGE",
         "■  China market exposure: Research A-share opportunities\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse Chinese market indices and major stocks\n"
...
QWidget* DocsScreen::page_gov_data() {
    return make_page("GOVERNMENT DATA", "Official government statistical data", {
        {"OVERVIEW",
         "Access official government data from statistical agencies worldwide including "
         "census data, economic surveys, trade statistics, and regulatory filings."},
        {"KEY FEATURES",
         "■  Multi-country government data sources\n"
         "■  Census and demographic data\n"
         "■  Trade and commerce statistics\n"
         "■  Regulatory filings and disclosures\n"
         "■  Historical data series with long time horizons"},
        {"REAL-WORLD USAGE",
         "■  Research: Access primary source economic data\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse available datasets, download basic reports\n"
...
QWidget* DocsScreen::page_geopolitics() {
    return make_page("GEOPOLITICS", "Conflict monitoring, HDX data, trade analysis, and relationship mapping", {
        {"OVERVIEW",
         "The Geopolitics screen provides a comprehensive view of global geopolitical events "
        ...
        {"KEY FEATURES",
         "■  Conflict monitor — Active global conflicts with severity tracking\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Risk management: Monitor geopolitical risks to your portfolio\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Monitor the conflict dashboard, understand risk scores\n"
...
QWidget* DocsScreen::page_maritime() {
    return make_page("MARITIME", "Maritime shipping and trade flow data", {
        {"OVERVIEW",
         "The Maritime screen provides shipping and trade flow data for monitoring global "
         "supply chains, commodity transport, and maritime trade patterns."},
        {"KEY FEATURES",
         "■  Vessel tracking — AIS data for major shipping routes\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Commodity trading: Track oil tanker movements for supply signals\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse shipping routes, understand trade flow basics\n"
...
QWidget* DocsScreen::page_polymarket() {
    return make_page("POLYMARKET", "Prediction markets and event probability trading", {
        {"OVERVIEW",
         "The Polymarket screen provides access to prediction market data, allowing you to "
         "track event probabilities and trade on real-world outcomes."},
        {"KEY FEATURES",
         "■  Event browser — Political, economic, sports, crypto events\n"
         "■  Probability charts — Historical probability movement\n"
         "■  Volume and liquidity data\n"
         "■  Category filtering and search\n"
         "■  Correlation with traditional markets"},
        {"REAL-WORLD USAGE",
         "■  Election trading: Track political event probabilities\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse events, understand probability pricing\n"
...
QWidget* DocsScreen::page_alt_investments() {
    return make_page("ALTERNATIVE INVESTMENTS", "Private equity, hedge funds, real assets, and alternatives data", {
        {"OVERVIEW",
         "The Alternative Investments screen covers non-traditional asset classes including "
         "private equity, hedge funds, real estate, commodities, and other alternatives."},
        {"KEY FEATURES",
         "■  PE/VC deal flow and fund performance\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Understand alternative asset classes and their role\n"
...
QWidget* DocsScreen::page_report_builder() {
    return make_page("REPORT BUILDER", "Drag-and-drop financial report creation", {
        {"OVERVIEW",
         "The Report Builder lets you create professional financial reports with a "
         "drag-and-drop interface. Combine charts, tables, text, and data from any "
         "terminal screen into presentation-ready documents."},
        {"KEY FEATURES",
         "■  Component toolbar — Charts, tables, text blocks, images, headers\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Client reports: Weekly market summary for advisory clients\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Create a simple one-page report with a chart and text\n"
...
QWidget* DocsScreen::page_node_editor() {
    return make_page("NODE EDITOR", "Visual workflow automation with drag-and-drop nodes", {
        {"OVERVIEW",
         "The Node Editor provides a visual programming environment for building "
        ...
        {"REAL-WORLD USAGE",
         "■  Alert systems: Price crosses MA → send notification\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Connect a data source to a simple alert node\n"
...
QWidget* DocsScreen::page_code_editor() {
    return make_page("CODE EDITOR", "Built-in code editor for trading strategies and scripts", {
        {"OVERVIEW",
         "The Code Editor provides a built-in development environment for writing "
        ...
        {"REAL-WORLD USAGE",
         "■  Strategy development: Write and test Python strategies\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Run example scripts, modify parameters\n"
...
QWidget* DocsScreen::page_excel() {
    return make_page("EXCEL", "Spreadsheet interface for financial analysis", {
        {"OVERVIEW",
         "The Excel screen provides a spreadsheet-style interface for financial "
         "analysis with formula support, data import/export, and charting."},
        {"KEY FEATURES",
         "■  Spreadsheet grid with formula support\n"
        ...
        {"REAL-WORLD USAGE",
         "■  Financial modeling: Build DCF models in a familiar interface\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Enter data, use basic formulas (SUM, AVG)\n"
...
QWidget* DocsScreen::page_notes() {
    return make_page("NOTES", "Persistent note-taking for research and trade journals", {
        {"OVERVIEW",
         "The Notes screen provides a persistent note-taking environment for maintaining "
        ...
        {"REAL-WORLD USAGE",
         "■  Trade journal: Record entry/exit rationale for every trade\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Create your first trade journal entry\n"
...
QWidget* DocsScreen::page_mcp_servers() {
    return make_page("MCP SERVERS", "Model Context Protocol server management", {
        {"OVERVIEW",
         "The MCP Servers screen manages Model Context Protocol servers that extend "
        ...
        {"REAL-WORLD USAGE",
         "■  Extend AI agents with custom data sources\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse available MCP servers, understand the concept\n"
...
QWidget* DocsScreen::page_data_mapping() {
    return make_page("DATA MAPPING", "Map and configure external data source connections", {
        {"OVERVIEW",
         "The Data Mapping screen lets you configure connections between external data "
        ...
        {"REAL-WORLD USAGE",
         "■  Connect proprietary data feeds to terminal widgets\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Browse configured data sources\n"
...
QWidget* DocsScreen::page_settings() {
    return make_page("SETTINGS", "Application configuration and preferences", {
        {"OVERVIEW",
         "The Settings screen provides comprehensive application configuration "
        ...
        {"SECTIONS",
         "■  General — Language, timezone, display density\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Set your timezone and preferred market\n"
...
QWidget* DocsScreen::page_profile() {
    return make_page("PROFILE", "User account, subscription, and usage tracking", {
        {"OVERVIEW",
         "The Profile screen displays your account information, subscription status, "
         "usage statistics, and billing history."},
        {"KEY FEATURES",
         "■  Account details — Name, email, registration date\n"
        ...
        {"SKILL LEVELS",
         "BEGINNER: Check your account status and plan\n"
...
void DocsScreen::build_sidebar() {
    ...
    // Navigation
    connect(sidebar_, &QTreeWidget::currentItemChanged, this,

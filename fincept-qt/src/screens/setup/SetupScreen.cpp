...
SetupScreen::SetupScreen(QWidget* parent) : QWidget(parent) {
    ...
    connect(&python::PythonSetupManager::instance(),
            &python::PythonSetupManager::progress_changed,
            this, &SetupScreen::on_progress);

    connect(&python::PythonSetupManager::instance(),
            &python::PythonSetupManager::setup_complete,
...
void SetupScreen::build_ui() {
    ...
    title->setStyleSheet(
        QString("color:%1; font-family:%2; font-size:24px; font-weight:700;")
    ...
    auto* desc = new QLabel(
        "Fincept Terminal requires Python and several analytics libraries.\n"
    ...
    desc->setStyleSheet(
        QString("color:%1; font-family:%2; font-size:11px; margin:10px 0;")
    ...
    begin_btn_->setStyleSheet(
        QString("QPushButton { background:%1; color:%2; border:none;"
            ...
            .arg(kAccent, colors::TEXT_PRIMARY, fonts::DATA_FAMILY,
    ...
    // Install dir info
    auto* dir_label = new QLabel(
        "Install directory: " + python::PythonSetupManager::instance().install_dir(),
        center);
    dir_label->setAlignment(Qt::AlignCenter);
    dir_label->setStyleSheet(
        QString("color:%1; font-family:%2; font-size:9px; margin-top:4px;")

...
if __name__ == "__main__":
    ...
    _QT_ARGMAP = {"comprehensive_analysis": [["cycle_phase_str", "raw"], ["economic_data", "json"]], "business_cycle_analysis": [["cycle_phase_str", "raw"]], "equity_risk_premium": [["risk_free_rate", "raw"], ["market_risk_premium", "raw"]]}

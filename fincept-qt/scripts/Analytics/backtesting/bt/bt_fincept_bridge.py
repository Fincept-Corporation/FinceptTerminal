#!/usr/bin/env python3
"""
BT <-> Fincept Strategy Bridge
Executes Fincept Engine strategies within BT provider
"""
...
def run_fincept_strategy(strategy_id: str, params_dict: dict) -> dict:
    """
    Execute Fincept strategy and return BT-compatible results.
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print(json.dumps({
            'success': False,
            'error': 'Usage: bt_fincept_bridge.py <strategy_id> <params_json>'
        }))
        sys.exit(1)

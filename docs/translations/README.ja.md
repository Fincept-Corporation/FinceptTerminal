...
> **C/C++ への移行**— バージョン 4 は純粋な C++ ネイティブ アプリケーションになります。現在の Tauri (React/Rust) ビルドはスタンドアロン リリースとして配布されなくなりました。 Tauri バージョンを実行するには、リポジトリをクローンして、次を使用します。`bun run tauri:dev`からの`fincept-terminal-desktop/`ディレクトリ。
...
| プラットフォーム  | 建築            | ダウンロード                                                                                                                              |
| --------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **macOS** | アップルシリコン      | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.3.3/FinceptTerminal-v3.3.3-macOS-arm64.dmg)    |
| **macOS** | インテル          | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.3.3/FinceptTerminal-v3.3.3-macOS-x64.dmg)      |
| **Linux** | x64 (アプリイメージ) | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.3.3/FinceptTerminal-v3.3.3-Linux-x64.AppImage) |
| **Linux** | x64 (Debian)  | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.3.3/FinceptTerminal-v3.3.3-Linux-x64.deb)      |
| **窓**     | ふーん           | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.3.3/FinceptTerminal-v3.3.3-Windows-x64.msi)    |
...
**2026 年第 1 四半期:**強化されたリアルタイム ストリーミング • 高度なバックテスト • オプション戦略ビルダー • 50 以上の AI エージェント**2026 年 5 月:**ペーパートレーディング • マルチポートフォリオ管理 • モバイルアプリ • ソーシャルトレーディング**未来：**制度上の機能 • プログラマティック API • ML トレーニング UI • ホワイトラベル ソリューション

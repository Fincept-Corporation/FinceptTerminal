...
| 🤖**एआई एजेंट**      | 20+ investor personas (Buffett, Dalio, Graham) • Hedge fund strategies (Bridgewater, Citadel, Renaissance) • Local LLM support | [एआई एजेंट](https://github.com/Fincept-Corporation/FinceptTerminal/tree/main/fincept-terminal-desktop/src-tauri/resources/scripts/agents)                                                                                                                                  |
...
|                                    GDP, inflation, rates, growth cycles                                   |                                  वित्तीय विवरण, डीसीएफ, विश्लेषक कवरेज                                  |                                    वैश्विक जोखिम निगरानी एवं परिदृश्य विश्लेषण                                    |

...
# INPUT: ticker symbols (array), end_date (string), FINANCIAL_DATASETS_API_KEY
# OUTPUT: Financial metrics (ROE, D/E, Current Ratio), Financial line items (Revenue, Net Income, FCF, Debt, Equity, Retained Earnings, Operating Margin, R&D, Shares), Market Cap
# PARAMETERS: period="annual", limit=10 years

"""
Financial Statement Data Processor
Handles universal data ingestion, standardization, and validation for all financial statement analysis.
Supports multiple data sources and formats while ensuring CFA-compliant data structure.
"""

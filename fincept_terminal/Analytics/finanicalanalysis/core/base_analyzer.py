...
Provides foundation for all financial statement analyzers with CFA-compliant methodologies.
Ensures consistent analysis framework across all specialized modules.
"""

...
def save_user_data(data):
    """
    Save user data to the FinceptTerminalSettings.json file.
    """
...
def is_registered():
    """
    Check if a user is registered by verifying the presence of 'name' in FinceptTerminalSettings.
    """
    settings = load_settings()
...
def clear_user_data():
    """
    Clear all user data by deleting the FinceptTerminalSettings.json file.
    """

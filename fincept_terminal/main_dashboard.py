...
from config import config, get_api_endpoint, is_strict_mode
...
try:
    from themes.theme_manager import AutomaticThemeManager
...
# Import tabs safely
TAB_IMPORTS = [
    ("dashboard", "dashboard_tab", "DashboardTab"),
    ("Market Tab", "market_tab", "MarketTab"),
    ...
    ("profile", "profile_tab", "ProfileTab"),
...
def main():
    ...
    try:
        ...
        if fresh_session:
            ...
            from splash_auth import show_authentication_splash
